...
public final class DefaultHorseCharacter extends AbstractPendragonBaseCharacter
    ...
    private final Map<String, ValueHandler> secondaryAttributes = new LinkedHashMap<>();
    private String                          type                = "";
    ...
    public DefaultHorseCharacter(final DefaultHorseCharacter horse) {
        ...
        for (final Entry<String, ValueHandler> entry : horse.secondaryAttributes
                .entrySet()) {
    ...
    @Override
    public final void addSecondaryAttribute(final ValueHandler attribute) {
        if (attribute == null) {
    ...
    @Override
    public final ValueHandler getSecondaryAttribute(final String name) {
        return _getSecondaryAttributes().get(name);
    }

    @Override
    public final Collection<ValueHandler> getSecondaryAttributes() {
    ...
    protected final Map<String, ValueHandler> _getSecondaryAttributes() {
